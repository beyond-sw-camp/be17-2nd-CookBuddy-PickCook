...
const checkEmail = () => {
  if (!isEmailValid) {
    ...
    const emailGuide = document.getElementById('cert-guide-message')
...
<template>
  <div class="login-and-signup-body" id="signup-body">
    <div class="signup-container">
      ...
      <form @submit.prevent="checkEmail" action="/signup/write" method="post">
        <!-- 이메일 입력란 -->
        <div class="form-items">
          ...
          <div
            ...
            @click="isEmailValid && checkEmail()"
          >
            이메일 인증하기
          </div>
          <span id="cert-guide-message" class="message-style"
            >입력하신 이메일로 인증 요청 메일을 보냈습니다.</span
          >
        </div>
        ...
        <div class="form-items">
          ...
          <span id="unusable-nickname-message" class="message-style"
            >이미 사용중인 닉네임입니다.</span
          >
        </div>
